...
int main() {
    ...
    constexpr int startSize = 2000;
    constexpr int endSize = 2000;
    constexpr int stepSize = 2000;
    ...
    Eigen::PowerMethodSVD<Eigen::SparseMatrix<double, Eigen::RowMajor>> power_method_svd;
    power_method_svd.compute(sparse, rank, 2);
