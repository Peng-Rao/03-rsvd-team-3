...
// Benchmark tests for Eigen::SparseQR
TEST_CASE("Eigen SparseQR Decomposition Benchmark", "[SparseQR_bench_dynamic]") {
    for (size_t idx = 0; idx < sparseMatrices.size(); ++idx) {
...
int main(int argc, char* argv[]) {
    ...
    const char* xmlReporterArgs[] = {"--reporter", "xml", "--out", "sparse_qr.xml"};
